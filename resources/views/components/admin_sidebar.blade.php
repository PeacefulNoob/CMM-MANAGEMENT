<!-- <div class="sidenav">
        ...
        @can('adman')
            <div> <a class="navbar-item" href="/news">List of all News

                </a></div>
          

            <div> <a class="navbar-item" href="/news/create">Add News Post

                </a></div>
            <div> <a class="navbar-item" href="/designs/create">Add Design packet
                </a></div>
                <div> <a class="navbar-item" href="/all_designs">List of all Design packets      
                          </a></div>
            <div> <a class="navbar-item" href="/maintenances/create">Add Maintenance packet
                </a></div>
                <div> <a class="navbar-item" href="/all_maintenances">List of all Maintenance packets      
                          </a></div>
              
                <div> <a class="navbar-item" href="/repairs/create">Add Repair packet
                </a></div>
        @endcan
</div>
 -->
<aside class="app-sidebar sidebar-scroll ps ps--active-y">
    ...
    <div class="main-sidemenu active">
        ...
        <ul class="side-menu">
            ...
            <li class="slide"> <a class="side-menu__item" data-toggle="slide" href="#"><span class="side-menu__label">Design</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
            ...
            <li class="slide"> <a class="side-menu__item" data-toggle="slide" href="#"><span class="side-menu__label">Mainenance</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
            ...
            <li class="slide"> <a class="side-menu__item" data-toggle="slide" href="#"><span class="side-menu__label">News</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
